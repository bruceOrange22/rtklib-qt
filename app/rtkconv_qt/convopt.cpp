...
void ConvOptDialog::showEvent(QShowEvent *event)
{
    ...
    Freq4->setChecked(mainWindow->FreqType&FREQTYPE_E6);
    Freq5->setChecked(mainWindow->FreqType&FREQTYPE_E5b);
...
void ConvOptDialog::BtnOkClick()
{
    ...
    if (Freq4->isChecked()) freqtype|=FREQTYPE_E6;
    if (Freq5->isChecked()) freqtype|=FREQTYPE_E5b;
...
{    
    ...
    if (Freq4->isChecked()) codeOptDialog->FreqType|=FREQTYPE_E6;
    if (Freq5->isChecked()) codeOptDialog->FreqType|=FREQTYPE_E5b;
